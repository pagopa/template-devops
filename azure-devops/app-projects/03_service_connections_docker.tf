...
#   azurecr_spn_tenantid      = module.secret_azdo.values["TENANTID"].value
#   azurecr_subscription_id   = module.secret_azdo.values["DEV-SUBSCRIPTION-ID"].value
# }
...
#   azurecr_spn_tenantid      = module.secret_azdo.values["TENANTID"].value
#   azurecr_subscription_id   = module.secret_azdo.values["UAT-SUBSCRIPTION-ID"].value
# }
...
#   azurecr_spn_tenantid      = module.secret_azdo.values["TENANTID"].value
#   azurecr_subscription_id   = module.secret_azdo.values["PROD-SUBSCRIPTION-ID"].value
# }
