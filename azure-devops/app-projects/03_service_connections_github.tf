...
resource "azuredevops_serviceendpoint_github" "azure-devops-github-ro" {
  ...
  auth_personal {
    personal_access_token = module.secret_azdos.values["azure-devops-github-ro-TOKEN"].value
  }
  lifecycle {
...
resource "azuredevops_serviceendpoint_github" "azure-devops-github-rw" {
  ...
  auth_personal {
    personal_access_token = module.secret_azdos.values["azure-devops-github-rw-TOKEN"].value
  }
  lifecycle {
    ignore_changes = [description, authorization]
  }
...
resource "azuredevops_serviceendpoint_github" "azure-devops-github-pr" {
  ...
  auth_personal {
    personal_access_token = module.secret_azdos.values["azure-devops-github-pr-TOKEN"].value
  }
  lifecycle {
    ignore_changes = [description, authorization]
  }
